<x-app-layout>
    ...
    {{-- INI KUNCINYA: Kita menggunakan @section('title') agar bisa ditangkap oleh @yield('title') di layout Anda --}}
    @section('title', 'Dashboard')


    {{-- Bagian ini akan masuk ke dalam {{ $slot }} --}}
    ...
    @php
        ...
        $kategoriData = \App\Models\Kategori::withCount('barang')->get();
        $chartLabels = $kategoriData->pluck('nama_kategori')->toJson();
        $chartValues = $kategoriData->pluck('barang_count')->toJson();
    @endphp

    {{-- Kita tidak perlu <div class="py-12"> lagi, karena layout Anda sudah punya "p-6" --}}
    <div class="space-y-6">
